...
export const EcsNested = {
  ...
  threat: {
    ...
    fields: {
      ...
      'threat.enrichments.indicator.file.code_signature.signing_id': {
        dashed_name:
          'threat-enrichments-indicator-file-code-signature-signing-id',
        description:
          'The identifier used to sign the process.\nThis is used to identify the application manufactured by a software vendor. The field is relevant to Apple *OS only.',
        example: 'com.apple.xpc.proxy',
        flat_name:
      ...
      'threat.enrichments.indicator.file.code_signature.timestamp': {
        dashed_name:
          'threat-enrichments-indicator-file-code-signature-timestamp',
        description:
          'Date and time when the code signature was generated and signed.',
        example: '2021-01-01T12:10:30Z',
      ...
      'threat.enrichments.indicator.file.elf.header.object_version': {
        dashed_name:
          'threat-enrichments-indicator-file-elf-header-object-version',
        description: '"0x1" for original ELF files.',
        flat_name:
          'threat.enrichments.indicator.file.elf.header.object_version',
        ignore_above: 1024,
      ...
      'threat.enrichments.indicator.file.elf.sections.physical_size': {
        dashed_name:
          'threat-enrichments-indicator-file-elf-sections-physical-size',
        description: 'ELF Section List physical size.',
        flat_name:
          'threat.enrichments.indicator.file.elf.sections.physical_size',
        format: 'bytes',
      ...
      'threat.enrichments.indicator.file.elf.sections.virtual_size': {
        dashed_name:
          'threat-enrichments-indicator-file-elf-sections-virtual-size',
        description: 'ELF Section List virtual size.',
        flat_name:
          'threat.enrichments.indicator.file.elf.sections.virtual_size',
        format: 'string',
      ...
      'threat.enrichments.indicator.file.x509.issuer.common_name': {
        dashed_name:
          'threat-enrichments-indicator-file-x509-issuer-common-name',
        description:
          'List of common name (CN) of issuing certificate authority.',
        example: 'Example SHA2 High Assurance Server CA',
      ...
      'threat.enrichments.indicator.file.x509.public_key_algorithm': {
        dashed_name:
          'threat-enrichments-indicator-file-x509-public-key-algorithm',
        description: 'Algorithm used to generate the public key.',
        example: 'RSA',
        flat_name:
          'threat.enrichments.indicator.file.x509.public_key_algorithm',
      ...
      'threat.enrichments.indicator.file.x509.public_key_exponent': {
        dashed_name:
          'threat-enrichments-indicator-file-x509-public-key-exponent',
        description:
          'Exponent used to derive the public key. This is algorithm specific.',
        doc_values: false,
        example: 65537,
      ...
      'threat.enrichments.indicator.file.x509.signature_algorithm': {
        dashed_name:
          'threat-enrichments-indicator-file-x509-signature-algorithm',
        description:
          'Identifier for certificate signature algorithm. We recommend using names found in Go Lang Crypto library. See https://github.com/golang/go/blob/go1.14/src/crypto/x509/x509.go#L337-L353.',
        example: 'SHA256-RSA',
      ...
      'threat.enrichments.indicator.file.x509.subject.common_name': {
        dashed_name:
          'threat-enrichments-indicator-file-x509-subject-common-name',
        description: 'List of common names (CN) of subject.',
        example: 'shared.global.example.net',
      ...
      'threat.enrichments.indicator.x509.issuer.distinguished_name': {
        dashed_name:
          'threat-enrichments-indicator-x509-issuer-distinguished-name',
        description:
          'Distinguished name (DN) of issuing certificate authority.',
        example:
          'C=US, O=Example Inc, OU=www.example.com, CN=Example SHA2 High Assurance Server CA',
      ...
      'threat.enrichments.indicator.x509.issuer.organizational_unit': {
        dashed_name:
          'threat-enrichments-indicator-x509-issuer-organizational-unit',
        description:
          'List of organizational units (OU) of issuing certificate authority.',
        example: 'www.example.com',
        flat_name:
      ...
      'threat.enrichments.indicator.x509.issuer.state_or_province': {
        dashed_name:
          'threat-enrichments-indicator-x509-issuer-state-or-province',
        description: 'List of state or province names (ST, S, or P)',
        example: 'California',
      ...
      'threat.enrichments.indicator.x509.subject.distinguished_name': {
        dashed_name:
          'threat-enrichments-indicator-x509-subject-distinguished-name',
        description:
          'Distinguished name (DN) of the certificate subject entity.',
        example:
          'C=US, ST=California, L=San Francisco, O=Example, Inc., CN=shared.global.example.net',
      ...
      'threat.enrichments.indicator.x509.subject.state_or_province': {
        dashed_name:
          'threat-enrichments-indicator-x509-subject-state-or-province',
        description: 'List of state or province names (ST, S, or P)',
        example: 'California',
        flat_name:
          'threat.enrichments.indicator.x509.subject.state_or_province',
  ...
  tls: {
    ...
    group: 2,
    name: 'tls',
    nestings: ['tls.client.x509', 'tls.server.x509'],
    prefix: 'tls.',
    reused_here: [
      {
  ...
  url: {
    ...
    reusable: {
      expected: [
        { as: 'url', at: 'threat.indicator', full: 'threat.indicator.url' },
        {
          as: 'url',
          at: 'threat.enrichments.indicator',
          full: 'threat.enrichments.indicator.url',
  ...
  user: {
    ...
    reusable: {
      expected: [
        { as: 'user', at: 'client', full: 'client.user' },
        { as: 'user', at: 'destination', full: 'destination.user' },
        { as: 'user', at: 'server', full: 'server.user' },
        { as: 'user', at: 'source', full: 'source.user' },
        {
          as: 'target',
          at: 'user',
          full: 'user.target',
  ...
  vlan: {
    ...
    reusable: {
      expected: [
        { as: 'vlan', at: 'observer.ingress', full: 'observer.ingress.vlan' },
        { as: 'vlan', at: 'observer.egress', full: 'observer.egress.vlan' },
        { as: 'vlan', at: 'network', full: 'network.vlan' },
        { as: 'vlan', at: 'network.inner', full: 'network.inner.vlan' },
      ],
      top_level: false,
    },
    short: 'Fields to describe observed VLAN information.',
  ...
  x509: {
    ...
    reusable: {
      expected: [
        { as: 'x509', at: 'file', full: 'file.x509' },
        { as: 'x509', at: 'threat.indicator', full: 'threat.indicator.x509' },
        {
          as: 'x509',
          at: 'threat.enrichments.indicator',
          full: 'threat.enrichments.indicator.x509',
        },
        { as: 'x509', at: 'tls.client', full: 'tls.client.x509' },
        { as: 'x509', at: 'tls.server', full: 'tls.server.x509' },
      ],
      top_level: false,
    },
    short: 'These fields contain x509 certificate metadata.',
